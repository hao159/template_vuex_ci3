...
$config['mongo_db']['default'] = [
	...
	// 'connection_string' => 'mongodb://worldsms:89f4bb0f888eb5672d14125dc738eb0e@192.168.25.25:27018/AdvWorldSMS?authSource=admin',

	'connection' => [
		'host'          => [ $_ENV['APP_MONGO_HOST'] ],
		'port'          => [ $_ENV['APP_MONGO_PORT'] ],
		'db_name'       =>  $_ENV['APP_MONGO_DB_NAME'],
		'user_name'     =>  $_ENV['APP_MONGO_DB_USER'],
		'user_password' =>  $_ENV['APP_MONGO_DB_PASS'],
		'db_options'    => []
	],
